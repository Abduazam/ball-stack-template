...
namespace Modules\Information\Policies\Language;
...
final class LanguagePolicy
{
    ...
    {
        return $user->hasPermissionTo($this->route . 'show') && ! $language->trashed();
    }
    ...
    {
        return $user->hasPermissionTo($this->route . 'edit') && ! $language->trashed();
    }
    ...
    {
        return $user->hasPermissionTo($this->route . 'delete') && ! $language->trashed() && $language->slug !== app()->getLocale();
    }
    ...
    {
        return $user->hasPermissionTo($this->route . 'restore') && $language->trashed();
    }
    ...
    {
        return $user->hasPermissionTo($this->route . 'destroy') && $language->trashed() && $language->slug !== app()->getLocale();
    }
