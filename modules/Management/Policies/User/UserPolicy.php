...
namespace Modules\Management\Policies\User;
...
final class UserPolicy
{
    ...
    {
        return $user->hasPermissionTo($this->route . 'show') && !$model->trashed();
    }
    ...
    {
        return $user->hasPermissionTo($this->route . 'edit') && !$model->trashed();
    }
    ...
    {
        return $user->hasPermissionTo($this->route . 'delete') && !$model->trashed() && !$model->self();
    }
    ...
    {
        return $user->hasPermissionTo($this->route . 'restore') && $model->trashed() && !$model->self();
    }
    ...
    {
        return $user->hasPermissionTo($this->route . 'destroy') && $model->trashed() && !$model->self();
    }
